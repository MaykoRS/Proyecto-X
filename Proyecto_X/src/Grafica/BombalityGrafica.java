...
/**
 * Clase correspondiente a la implementación de la parte gráfica del PowerUp Bombality.
 ...
 */
	public class BombalityGrafica extends PowerUPGrafica {
		...
		public BombalityGrafica(int x,int y) {
			...
			this.image = new ImageIcon(this.getClass().getResource("/Bomberman/Bombality.png"));
